...
Pronounced person names are automatically extracted from the audio stream using a large list of names gathered from the Wikipedia website.
...
We also thank INA, LIUM, UPC and IDIAP for providing datasets and baseline modules.
